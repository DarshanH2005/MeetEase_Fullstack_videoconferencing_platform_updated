  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible &&
          "bg-white/10 dark:bg-neutral-950/10 backdrop-blur-md border border-white/20 dark:border-white/10",
        className
      )}
    >
      {children}
  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">MeetEase</span>
    </a>
  );
};
